...
def test_cli_comprehensive():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        # Note: Due to CSS optimization and class purging, we verify the HTML contains
        # the classes but the CSS contains the base framework rather than checking for
        # specific utility CSS rules which may be optimized or purged.
